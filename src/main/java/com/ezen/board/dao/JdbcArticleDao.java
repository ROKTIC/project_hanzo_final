...
public class JdbcArticleDao implements ArticleDao {
     ...
     * @throws SQLException
     */
    public boolean deleteArticle(int articleNum) throws SQLException {
        StringBuilder sql = new StringBuilder();
    ...
    /**
     * 댓글있는 게시글은 게시글만 삭제 후 삭제된 게시글이라고 표기 UPDATE 하기
     * @param articleNum
     * @return
     * @throws SQLException
     */
//    public void deleteArticleComment(int articleNum) throws SQLException {
//        StringBuilder sql = new StringBuilder();
//        sql.append(" DELETE article_comment")
//           .append(" WHERE article_num = ? ");
//        Connection con = connectionFactory.getConnection();
//        PreparedStatement pstmt = null;
//        try {
...
//        System.out.println(articleDao.deleteArticle(7));
//        List<Article> list = jdbcArticleDao.findByAll(10,10,1,"t", "안녕");
